...
import 'package:resonix/pages/artist/albums.dart';
import 'package:resonix/pages/artist/tracks.dart';
...
class ArtistPageState extends State<ArtistPage> {
  ...
  Future<void> loadTopAlbums() async {
    var albums = await ApiService.getArtistTopAlbums(widget.id);
    if (!mounted) return;
    if (albums != null) {
                            ...
                            Expanded(
                              child: SingleChildScrollView(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    _sectionTitle("Top Albums", "allAlbums"),
                                    topAlbums == null
                                        ? _buildSkeletonGrid()
                                        : _buildAlbumGrid(context),
                                    _sectionTitle("Top Tracks", "allTracks"),
                                    topTracks == null
                                        ? _buildSkeletonList()
