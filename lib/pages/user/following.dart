...
class UserFollowingPage extends StatefulWidget {
  ...
  @override
  UserFollowingPageState createState() => UserFollowingPageState();
}
...
class UserFollowingPageState extends State<UserFollowingPage> {
  ...
  Future<void> loadFollowing() async {
    var following = await ApiService.getFollowing(widget.userId);
    if (!mounted) return;
    if (following != null) {
      if (following["error"] != null) {
        return ApiService.returnError(context, following["error"]);
      }
      setState(() {
                            ...
                            Expanded(
                              child: SingleChildScrollView(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    _sectionTitle(((data?["nickname"] == null ? null : (data["nickname"] + "'s ")) ??
                                        (data?["username"] == null ? null : (data["username"] + "'s ")) ?? "") + "Following"),
                                    following == null
                                        ? _buildSkeletonList()
